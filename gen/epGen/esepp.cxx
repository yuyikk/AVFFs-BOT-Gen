...
for (loop = 0; loop < nev_0; loop++)
  ...
  if (flag_dat == true)  // Writing the event to the *.dat file
    {
    if (flag_target == false) fprintf(f0, "%11.5lf %10.8lf %11.8lf %11.5lf %10.8lf %11.8lf %11.5lf %10.8lf %11.8lf\n", 1000.*E_lf, theta_l, phi_l, 1000.*E_p, theta_p, phi_p, 1000.*E_g, theta_g, phi_g);
    else fprintf(f0, "%11.5lf %10.8lf %11.8lf %11.5lf %10.8lf %11.8lf %11.5lf %10.8lf %11.8lf %6.1lf\n", 1000.*E_lf, theta_l, phi_l, 1000.*E_p, theta_p, phi_p, 1000.*E_g, theta_g, phi_g, zcoord);
    }
...
for (loop = 0; loop < nev_e; loop++)
  ...
  if (flag_dat == true)  // Writing the event to the *.dat file
    {
    if (flag_target == false) fprintf(fe, "%11.5lf %10.8lf %11.8lf %11.5lf %10.8lf %11.8lf %11.5lf %10.8lf %11.8lf\n", 1000.*E_lf, theta_l, phi_l, 1000.*E_p, theta_p, phi_p, 1000.*E_g, theta_g, phi_g);
    else fprintf(fe, "%11.5lf %10.8lf %11.8lf %11.5lf %10.8lf %11.8lf %11.5lf %10.8lf %11.8lf %6.1lf\n", 1000.*E_lf, theta_l, phi_l, 1000.*E_p, theta_p, phi_p, 1000.*E_g, theta_g, phi_g, zcoord);
    }
...
for (loop = 0; loop < nev_p; loop++)
  ...
  if (flag_dat == true)  // Writing the event to the *.dat file
    {
    if (flag_target == false) fprintf(fp, "%11.5lf %10.8lf %11.8lf %11.5lf %10.8lf %11.8lf %11.5lf %10.8lf %11.8lf\n", 1000.*E_lf, theta_l, phi_l, 1000.*E_p, theta_p, phi_p, 1000.*E_g, theta_g, phi_g);
    else fprintf(fp, "%11.5lf %10.8lf %11.8lf %11.5lf %10.8lf %11.8lf %11.5lf %10.8lf %11.8lf %6.1lf\n", 1000.*E_lf, theta_l, phi_l, 1000.*E_p, theta_p, phi_p, 1000.*E_g, theta_g, phi_g, zcoord);
    }
